...
esptool.py  --chip esp32s3 merge_bin -o bin/$BINNAME --flash_mode=keep --flash_size 4MB 0x0000 .pio/build/fishbot_motion_control_four_driver_v2/bootloader.bin 0x8000 .pio/build/fishbot_motion_control_four_driver_v2/partitions.bin  0xe000 ./boards/boot_app0.bin  0x10000 .pio/build/fishbot_motion_control_four_driver_v2/firmware.bin 
