...
esptool.py  --chip esp32 merge_bin -o bin/$BINNAME --flash_mode dio --flash_size 4MB 0x1000 .pio/build/fishbot_motion_control_four_driver_v2/bootloader.bin 0x8000 .pio/build/fishbot_motion_control_four_driver_v2/partitions.bin  0x10000 .pio/build/fishbot_motion_control_four_driver_v2/firmware.bin 
